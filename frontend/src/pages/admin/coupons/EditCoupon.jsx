    ...
    if (coupon) {
      reset({
        ...
        applicableCategories:
          coupon.applicableCategories?.map(
            (c) => c._id
          ) || [],
        discount: {
          type:
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-text-muted mt-2 text-sm sm:text-base">
              Update coupon details, discount
