...
return(
  <div className="min-h-screen flex justify-center items-center bg-bg-soft ">
      ...
      <div className=" w-full md:w-1/3  h-1/2    p-10 m-10  rounded-lg shadow-md bg-bg-main mt-10">
        <h1 className='text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center font-bold mt-5'>Forgot Password?</h1>
         <h6 className='text-xs sm:text-base md:text-sm lg:text-lg text-center text-primary mt-4 mb-6'>No worries! Enter your email and 
          we’ll send you a
                                         reset link.
</h6>
         ...
         <form onSubmit={handleSubmit(onSubmit)}>
             ...
             <FormInput
                    ...
                    <div className="mt-6 text-center text-lg text-text-muted">
