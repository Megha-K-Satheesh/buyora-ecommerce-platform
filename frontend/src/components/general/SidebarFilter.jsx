...
const SidebarFilter = ({level1,level2,level3, filters,  selectedBrands, selectedColors, selectedSizes,  selectedDiscounts,  onFilterChange,  selectedPriceRange }) =>{ 
  ...
  <div className="w-64  ml-7 mt-2  ">
    <h3 className="text-lg font-semibold mb-2">Filters</h3>
     <div className="border-r border-r-border-light">

   
        {filters.categories?.length > 0 && (
  <div className="w-full border-t border-t-border-light py-3">
    ...
    {filters.brands?.length > 0 && (
      <div className=" border-t border-t-border-light py-3">
...
{filters?.priceRange &&
 filters.priceRange.min < filters.priceRange.max && (
  <div className="border-t border-t-border-light py-4">
    ...
    {filters.sizes?.length > 0 && (
     ...
     {filters.discountRanges?.length > 0 && (
      <div className="mb-4 border-t border-t-border-light py-4">
